	jsv u0 (
		...
		.imag_val_export                          (<connected-to-imag_val_export>),                          //                 imag_val.export
		...
		.real_val_export                          (<connected-to-real_val_export>),                          //                 real_val.export
		...
		.vga_interface_bitmap_io_sdram_x          (<connected-to-vga_interface_bitmap_io_sdram_x>),          //                         .sdram_x
		.vga_interface_bitmap_io_sdram_y          (<connected-to-vga_interface_bitmap_io_sdram_y>),          //                         .sdram_y
